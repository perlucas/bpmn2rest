 ...
 *******************************************************************************/
package org.eclipse.contributions.bpmn2rest.acceleo.module.main;
...
public class Main extends AbstractAcceleoGenerator {
    ...
    public String getModuleName() {
    	...
    	/* for debugging of the file name:
    	System.out.println(Main.class.getResource("Main.class") + "/main"); // bundle resource
    	System.out.println("\n");

    	System.out.println(findModuleURL("main"));
    	System.out.println("\n");
    	
    	System.out.println(findModuleURL(MODULE_FILE_NAME));
		*/
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.bpmn2.Bpmn2Package.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.bpmn2.Bpmn2Package.eINSTANCE.getNsURI(), org.eclipse.bpmn2.Bpmn2Package.eINSTANCE);
        }
